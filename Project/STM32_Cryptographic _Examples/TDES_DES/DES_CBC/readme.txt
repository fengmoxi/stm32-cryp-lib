...
DES algorithm routines returns DES_SUCCESS in case of successful Encryption or
...
@par Directory contents
  ...
  - TDES_DES/DES_CBC/main.c          Main program
                     
@note The System Clock configuration are handled in the cryptographic library
      project template for each device, and can be easily customized to your own
      configuration.
